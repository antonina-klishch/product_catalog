...
export const ShopByCategory: React.FC<Props> = ({ products }) => {
  ...
  return (
    <div className="category">
      ...
      <div className="category__block-links" data-cy="categoryLinksContainer">
        <Link to="/phones" className="category__link">
          ...
          <p className="category__number">{phones.length}</p>
        </Link>
        <Link to="/tablets" className="category__link">
          ...
          <p className="category__number">{tablets.length}</p>
        </Link>
        <Link to="/accessories" className="category__link">
          {/* eslint-disable-next-line max-len */}
          <div className="category__image-block category__image-block--accessories">
            <img
          ...
          <p className="category__number">{accessories.length}</p>
        </Link>
      </div>
    </div>
  );
