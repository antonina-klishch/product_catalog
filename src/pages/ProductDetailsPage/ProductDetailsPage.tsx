...
export const ProductDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    getSuggestedProducts().then(setRecommendedItems);
  }, [selectedId]);
                ...
                <div className="product-details__info-block">
                    ...
                    <div className="product-details__info-container-selectors">
                      ...
                      <ul className="product-details__parameters-container">
                        {currentItem.capacityAvailable.map(capacityProduct => (
                          ...
                          >
                            <Link
                              className={cn('product-details__capacity-link', {
                    ...
                    <div className="product-details__buttons">
                      ...
                      >
                        <span
                          ...
                          className={cn('icon', {
                            'icon--favourites': !isFavoriteProduct(
                              favoriteProducts,
                              currentItem,
                            ),
                            'icon--favourites-filled': isFavoriteProduct(
                              favoriteProducts,
                              currentItem,
                            ),
                          })}
                  ...
                  <div className="product-details__info-container">
                    <div className="product-details__info">
                      <p className="product-details__info-title">Screen</p>
                    ...
                    <div className="product-details__info">
                      <p className="product-details__info-title">Resolution</p>
                      <p className="product-details__info-text">
                    ...
                    <div className="product-details__info">
                      <p className="product-details__info-title">Processor</p>
                      <p className="product-details__info-text">
                        {currentItem.processor}
                      </p>
                    </div>
                    <div className="product-details__info">
                      <p className="product-details__info-title">RAM</p>
                      <p className="product-details__info-text">
                        {currentItem.ram}
                      </p>
                    </div>
            ...
            >
              <div className="product-details__grid">
                <div className="product-details__about-block">
                  <h2 className="product-details__title-block">About</h2>
                ...
                <div className="product-details__tech-block">
                  ...
                  <ul className="product-details__tech-list">
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Screen</p>
                      <p className="product-details__tech-text">
                        {currentItem.screen}
                      </p>
                    </li>
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Resolution</p>
                      <p className="product-details__tech-text">
                        {currentItem.resolution}
                      </p>
                    </li>
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Processor</p>
                      <p className="product-details__tech-text">
                        {currentItem.processor}
                      </p>
                    </li>
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">RAM</p>
                      <p className="product-details__tech-text">
                        {currentItem.ram}
                      </p>
                    </li>
                    ...
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Camera</p>
                      <p className="product-details__tech-text">
                        {currentItem.camera}
                      </p>
                    </li>
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Zoom</p>
                      <p className="product-details__tech-text">
                        {currentItem.zoom}
                      </p>
                    </li>
                    <li className="product-details__tech-item">
                      <p className="product-details__tech-title">Cell</p>
                      <p className="product-details__tech-text">
                        {currentItem.cell}
                      </p>
                    </li>
